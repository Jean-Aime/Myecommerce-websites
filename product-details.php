					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									<?php echo htmlentities($rws['productPrice']);?>.00  Frw
								</span>
									
							    <!-- <span class="price-before-discount"><?php echo htmlentities($row['productPriceBeforeDiscount']);?>  Frw</span>					 -->
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price"><?php echo htmlentities($row['productPrice']);?>  Frw</span>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					<?php echo htmlentities($rw['productPrice']);?>	Frw		</span>
