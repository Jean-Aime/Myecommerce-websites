...
if(isset($_POST['submit'])){
		...
		foreach($_POST['quantity'] as $key => $val){
			...
			echo "<script>alert('Your Cart has been Updated');window.location='my-cart.php';</script>";
			exit();
		}
	}
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo ""." ".$row['productPrice']; ?>.00 Frw</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo ""." ".$row['shippingCharge']; ?>.00 Frw</span></td>

					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>.00 Frw</span></td>
				</tr>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Grand Total<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?> Frw</span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
