...
<div class="logo">
    <a href="index.php">
        <img src="img/sabrina.png" alt="Sabrina Fresh Market Logo" style="width: 200px; height: auto;">
    </a>
</div>
	...
	?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price"><?php echo ($row['productPrice']+$row['shippingCharge']); ?>  Frw <?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Total :</span><span class='price'><?php echo $_SESSION['tp']="$totalprice". ".00"; ?> Frw</span>
